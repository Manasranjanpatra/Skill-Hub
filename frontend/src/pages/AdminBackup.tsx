    ...
    try {
      ...
      if (data.status === 'success') {
        ...
        setTimeout(() => {
          ...
          // Refresh backup history to show the new backup
          fetchBackupHistory();
        }, 1000);
      } else {
            ...
            <div className="stat-card info">
              ...
              <div className="stat-content">
                ...
                <div style={{ marginTop: '12px' }}>
                  ...
                  <div style={{ fontSize: '12px', color: '#718096', marginTop: '6px', textAlign: 'center' }}>76% available</div>
                </div>
              </div>
            </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  color: activeTab === 'logs' ? 'white' : '#4a5568',
                  borderRadius: '10px 10px 0 0',
                  fontWeight: '600',
                  cursor: 'pointer',
                  display: 'flex',
            ...
            {activeTab === 'settings' && (
              <div>
                ...
                <div style={{ marginBottom: '40px' }}>
                  <h4 style={{ marginBottom: '20px', color: '#4a5568' }}>Backup Frequency</h4>
                  <div style={{ display: 'flex', gap: '20px' }}>
                    <div
                      onClick={() => setFrequency('Daily')}
                      style={{
                        padding: '20px',
                        border: `2px solid ${frequency === 'Daily' ? '#667eea' : '#e2e8f0'}`,
                        borderRadius: '10px',
                        cursor: 'pointer',
                        background: frequency === 'Daily' ? '#f0f4ff' : 'white',
                        flex: 1,
                        textAlign: 'center',
                        transition: 'all 0.3s ease'
                      }}
                    >
                      <FaCalendarAlt size={24} color={frequency === 'Daily' ? '#667eea' : '#a0aec0'} style={{ marginBottom: '10px' }} />
                      <h5 style={{ margin: '0 0 5px 0', color: '#2d3748' }}>Daily</h5>
                      <p style={{ margin: 0, color: '#718096', fontSize: '14px' }}>Automatic backup every day at 2:00 AM</p>
                    </div>
                    <div
                      onClick={() => setFrequency('Weekly')}
                      style={{
                        padding: '20px',
                        border: `2px solid ${frequency === 'Weekly' ? '#667eea' : '#e2e8f0'}`,
                        borderRadius: '10px',
                        cursor: 'pointer',
                        background: frequency === 'Weekly' ? '#f0f4ff' : 'white',
                        flex: 1,
                        textAlign: 'center',
                        transition: 'all 0.3s ease'
                      }}
                    >
                      <FaCalendarAlt size={24} color={frequency === 'Weekly' ? '#667eea' : '#a0aec0'} style={{ marginBottom: '10px' }} />
                      <h5 style={{ margin: '0 0 5px 0', color: '#2d3748' }}>Weekly</h5>
                      <p style={{ margin: 0, color: '#718096', fontSize: '14px' }}>Automatic backup every Sunday at 2:00 AM</p>
                    </div>
                  </div>
                </div>
            ...
            {activeTab === 'logs' && (
              <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                <FaFileAlt size={48} color="#a0aec0" style={{ marginBottom: '20px' }} />
                <h3 style={{ margin: '0 0 10px 0', color: '#4a5568' }}>No Recent Errors</h3>
                <p style={{ margin: 0, color: '#718096' }}>
                  All backup operations completed successfully. No errors to display.
                </p>
              </div>
            )}
          </div>
