      ...
      <div className="flex">
        ...
        <div style={{ marginLeft: sidebarWidth + 16, flex: 1, transition: "all 0.3s ease", minHeight: "100vh" }}>
          <div style={{ position: "fixed", top: 0, left: sidebarWidth, right: 0, zIndex: 999 }}>
            <NewHeader avatar={teacherData.avatar} name={teacherData.name} role={teacherData.role} />
          </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <div className={`font-bold text-lg ${
                              selectedClass === className ? 'text-strong' : 'text-gray-800'
                            }`}>Class {className}</div>
                            <div className={`text-sm ${
                              selectedClass === className ? 'muted' : 'text-gray-500'
                            }`}>
                              {Object.keys(classData[className]?.subjects || {}).length} subjects
                            </div>
                          </div>
                          <div className={`text-2xl transition-transform group-hover:scale-110 ${
                            selectedClass === className ? 'rotate-12' : ''
                          }`}>
                            📚
                          </div>
                        </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              <div className={`font-bold ${
                                selectedSubject === subjectName ? 'text-strong' : 'text-gray-800'
                              }`}>{subjectName}</div>
                              <div className={`text-sm ${
                                selectedSubject === subjectName ? 'muted' : 'text-gray-500'
                              }`}>
                            ...
                            <div className={`text-xl transition-transform group-hover:scale-110 ${
                              selectedSubject === subjectName ? 'rotate-12' : ''
                            }`}>
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <div className={`font-bold text-sm leading-tight mb-1 ${
                                selectedChapter === chapterName ? 'text-strong' : 'text-gray-800'
                              }`}>{chapterName}</div>
                              <div className={`text-xs ${
                                selectedChapter === chapterName ? 'muted' : 'text-gray-500'
                              }`}>
                            ...
                            <div className={`text-lg transition-transform group-hover:scale-110 ${
                              selectedChapter === chapterName ? 'rotate-12' : ''
                            }`}>
                              📑
                            </div>
                          </div>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                <div className={`text-xl ${
                                  selectedLesson === lessonName ? 'animate-bounce' : ''
                                }`}>
                                  🎯
                                </div>
                                <div>
                                  <span className={`font-bold ${
                                    selectedLesson === lessonName ? 'text-white' : 'text-gray-800'
                                  }`}>{lessonName}</span>
                                </div>
                              </div>
                              <div className="flex items-center gap-3">
                                ...
                                <ChevronRight size={20} className={`transition-transform duration-300 ${
                                  selectedLesson === lessonName ? 'rotate-90' : ''
                                }`} />
                              </div>
                            </div>
                          </div>
